...
public class CardService : ICardService
{
    ...
    private List<TarotCard> cards = new List<TarotCard>
        {
            new TarotCard { Id = 1, Name = "Шут", GoodPercent = 90, Meaning = GenerateMeaning() },
            new TarotCard { Id = 2, Name = "Маг", GoodPercent = 95, Meaning = GenerateMeaning() },
            new TarotCard { Id = 3, Name = "Верховная Жрица", GoodPercent = 85, Meaning = GenerateMeaning() },
            new TarotCard { Id = 4, Name = "Императрица", GoodPercent = 90, Meaning = GenerateMeaning() },
            new TarotCard { Id = 5, Name = "Император", GoodPercent = 80, Meaning = GenerateMeaning() },
            new TarotCard { Id = 6, Name = "Жрец", GoodPercent = 85, Meaning = GenerateMeaning() },
            new TarotCard { Id = 7, Name = "Влюбленные", GoodPercent = 70, Meaning = GenerateMeaning() },
            new TarotCard { Id = 8, Name = "Колесница", GoodPercent = 80, Meaning = GenerateMeaning() },
            new TarotCard { Id = 9, Name = "Сила", GoodPercent = 90, Meaning = GenerateMeaning() },
            new TarotCard { Id = 10, Name = "Отшельник", GoodPercent = 75, Meaning = GenerateMeaning() },
            new TarotCard { Id = 11, Name = "Колесо Фортуны", GoodPercent = 85, Meaning = GenerateMeaning() },
            new TarotCard { Id = 12, Name = "Справедливость", GoodPercent = 85, Meaning = GenerateMeaning() },
            new TarotCard { Id = 13, Name = "Повешенный", GoodPercent = 50, Meaning = GenerateMeaning() },
            new TarotCard { Id = 14, Name = "Смерть", GoodPercent = 65, Meaning = GenerateMeaning() },
            new TarotCard { Id = 15, Name = "Умеренность", GoodPercent = 70, Meaning = GenerateMeaning() },
            new TarotCard { Id = 16, Name = "Дьявол", GoodPercent = 40, Meaning = GenerateMeaning() },
            new TarotCard { Id = 17, Name = "Башня", GoodPercent = 30, Meaning = GenerateMeaning() },
            new TarotCard { Id = 18, Name = "Звезда", GoodPercent = 90, Meaning = GenerateMeaning() },
            new TarotCard { Id = 19, Name = "Луна", GoodPercent = 60, Meaning = GenerateMeaning() },
            new TarotCard { Id = 20, Name = "Солнце", GoodPercent = 95, Meaning = GenerateMeaning() },
            new TarotCard { Id = 21, Name = "Суд", GoodPercent = 80, Meaning = GenerateMeaning() },
            new TarotCard { Id = 22, Name = "Мир", GoodPercent = 90, Meaning = GenerateMeaning() }
        };
